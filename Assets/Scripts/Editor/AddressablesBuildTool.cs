...
namespace fireMCG.PathOfLayouts.EditorTools
{
    ...
    {
        [MenuItem("Path of Layouts/Addressables/Configure/PC Local")]
        ...
        [MenuItem("Path of Layouts/Addressables/Configure/LinuxLocal")]
        ...
        [MenuItem("Path of Layouts/Addressables/Configure/Android CCD")]
        ...
        [MenuItem("Path of Layouts/Addressables/Build/Build Content (Current Target Platform)")]
        ...
        [MenuItem("Path of Layouts/Addressables/Build/Android CCD Content")]
        ...
        [MenuItem("Path of Layouts/Addressables/Build/Windows Local Content")]
        ...
        [MenuItem("Path of Layouts/Addressables/Build/Linux Local Content")]
